...
const meanScore = (...score) => {
  let sum = null;
   score.forEach(element => {
    if(typeof element !== "number"){
      throw 'Supplied arguments must contain only numbers!';
    }
    return sum += element;
  })
...
console.log(meanScore(...scores1, ...scores2, ...scores3, ...scores4)); // Supplied arguments must contain only numbers!
